...
{
	class CurrentPositionMessage : SendMessage
	{
		...
		public CurrentPositionMessage ()
		{
		}

		public CurrentPositionMessage (float move_x, float move_y, float move_z, float rotate_x, float rotate_y, float rotate_z, float current_x, float current_y, float current_z ){
			this._moveX = move_x;
			this._moveY = move_y;
			this._moveZ = move_z;
